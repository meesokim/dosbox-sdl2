    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        switch(event.getAction()) {
            case MotionEvent.ACTION_DOWN :
				...
				if (x > width/2) {
					SDLActivity.onNativeKeyDown(KeyEvent.KEYCODE_SPACE /*KeyEvent.KEYCODE_ENTER*/);
//					SDLActivity.onNativeKeyDown(57 /*KeyEvent.KEYCODE_LCTRL*/);
					if (y > height/2) {
						SDLActivity.onNativeKeyDown(133 /*KeyEvent.KEYCODE_F3*/);
						SDLActivity.onNativeKeyUp(133);
						SDLActivity.onNativeKeyDown(138 /*KeyEvent.KEYCODE_F7*/);
						SDLActivity.onNativeKeyUp(138);
					} else {
						onNativeKeyDown(132);
						onNativeKeyUp(132);
						SDLActivity.onNativeKeyDown(137 /*KeyEvent.KEYCODE_F7*/);
